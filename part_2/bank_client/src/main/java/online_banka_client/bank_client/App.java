...
record BankAcc(String IBAN, double balance, String value) {}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			// stanje racuna
				...
				try {
					BankAcc response = rest.getForObject(serverAddr + "/users/" + user.username + "/account-details", BankAcc.class);
...
//				// dohvati povijest transakcija
				...
				try {
					userIBAN = rest.getForObject(serverAddr + "/users/" + user.username + "/account-details", BankAcc.class).IBAN();
				} catch (RestClientException e) {
					System.out.println("Nemoguce dohvatiti podatke o racunu: " + e.getMessage());
				}
